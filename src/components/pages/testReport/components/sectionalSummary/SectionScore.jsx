      ...
      {activeTab === "Score" && (
        ...
        <div className="flex items-center gap-2 justify-between my-4">
          ...
          <div className="flex flex-col ">
            ...
            <span className="font-semibold flex items-center"><p className="text-orange-500">{totalMarks}</p>/{maxMarks}</span>
          </div>
          </div>
        ...
        <div className="flex flex-col gap-2">
          {generatedModules?.length > 0 &&
            generatedModules?.map((module, index) => (
              <div className="flex flex-col gap-2  w-100 " key={index}>
                <div className="border border-green-400 rounded-lg h-auto px-4 py-2">
